...
static void draw_settings_overlay(effect_runtime *runtime)
{
	...
	for (const auto &[depth_stencil, info] : sorted_item_list)
	{
			...
			ImGui::Checkbox(label, &value))
		{
			...
			force_reset = true;
			reshade::log::message(reshade::log::level::warning, "**Generic Depth add on selected ");
		}
...
{
	reshade::log::message(reshade::log::level::warning, "**Generic Depth add on register_addon_depth");
...
{
	reshade::log::message(reshade::log::level::warning, "**Generic Depth add on DLL MAIN");
	switch (fdwReason)
	{
